...
use FluentPlugin\Framework\Pagination\Paginator;
use FluentPlugin\Framework\Database\Query\Expression;
use FluentPlugin\Framework\Pagination\LengthAwarePaginator;
...
class Builder
{
     ...
     *
     * @var \FluentPlugin\Framework\Database\Query\Builder
     */
    protected $query;
     ...
     *
     * @var \FluentPlugin\Framework\Database\Orm\Model
     */
    protected $model;
     ...
     * @param  \FluentPlugin\Framework\Database\Orm\Scope|\Closure  $scope
     * @return $this
     */
     ...
     *
     * @param  \FluentPlugin\Framework\Database\Orm\Scope|string  $scope
     * @return $this
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \FluentPlugin\Framework\Database\Orm\Model|\FluentPlugin\Framework\Database\Orm\Collection|static[]|static|null
     */
     ...
     *
     * @param  array  $columns
     * @return \FluentPlugin\Framework\Database\Orm\Model|static|null
     */
     ...
     *
     * @param  array  $columns
     * @return \FluentPlugin\Framework\Database\Orm\Collection|static[]
     */
     ...
     *
     * @param  string  $name
     * @return \FluentPlugin\Framework\Database\Orm\Relations\Relation
     */
     ...
     * @param  string  $operator
     * @param  mixed   $value
     * @return \FluentPlugin\Framework\Database\Orm\Builder|static
     */
     ...
     *
     * @param  \FluentPlugin\Framework\Database\Orm\Builder  $hasQuery
     * @param  \FluentPlugin\Framework\Database\Orm\Relations\Relation  $relation
     * @param  string  $operator
     * @param  int  $count
     * @param  string  $boolean
     * @return \FluentPlugin\Framework\Database\Orm\Builder|static
     ...
     *
     * @param  \FluentPlugin\Framework\Database\Orm\Builder  $relation
     * @return \FluentPlugin\Framework\Database\Orm\Builder|static
     */
