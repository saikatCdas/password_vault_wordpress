...
namespace FluentPlugin\Framework\Database\Query;
...
use FluentPlugin\Framework\Support\Collection;
use FluentPlugin\Framework\Pagination\Paginator;
use FluentPlugin\Framework\Pagination\LengthAwarePaginator;
use FluentPlugin\Framework\Support\MacroableTrait;
use FluentPlugin\Framework\Database\Query\Grammar;
use FluentPlugin\Framework\Database\Query\Processor;
use FluentPlugin\Framework\Support\ArrayableInterface;
use FluentPlugin\Framework\Database\ConnectionInterface;
...
class Builder
{
     ...
     *
     * @var \FluentPlugin\Framework\Database\Query\WPDBConnection
     */
     ...
     *
     * @var \FluentPlugin\Framework\Database\Query\Grammar
     */
    protected $grammar;
     ...
     *
     * @var \FluentPlugin\Framework\Database\Query\Processor
     */
    protected $processor;
     ...
     *
     * @param  \FluentPlugin\Framework\Database\ConnectionInterface  $connection
     * @param  \FluentPlugin\Framework\Database\Query\Grammar  $grammar
     * @param  \FluentPlugin\Framework\Database\Query\Processor  $processor
     * @return void
     */
     ...
     * @return \FluentPlugin\Framework\Database\Query\Builder|static
     */
     ...
     *
     * @param  \Closure|\FluentPlugin\Framework\Database\Query\Builder|string $query
     * @param  string  $as
     * @return \FluentPlugin\Framework\Database\Query\Builder|static
     *
     ...
     *
     * @param  \FluentPlugin\Framework\Database\Query\Builder|static $query
     * @param  string  $boolean
     * @return $this
     */
     ...
     *
     * @param  \FluentPlugin\Framework\Database\Query\Builder|\Closure  $query
     * @param  bool  $all
     * @return \FluentPlugin\Framework\Database\Query\Builder|static
     */
     ...
     * @param  int|null  $page
     * @return \FluentPlugin\Framework\Pagination\LengthAwarePaginatorInterface
     */
     ...
     * @param  string  $pageName
     * @param  int|null  $page
     * @return \FluentPlugin\Framework\Pagination\PaginatorInterface
     */
     ...
     *
     * @param  mixed  $value
     * @return \FluentPlugin\Framework\Database\Query\Expression
     */
     ...
     *
     * @return \FluentPlugin\Framework\Database\Query\Processor
     */
     ...
     *
     * @return \FluentPlugin\Framework\Database\Query\Grammar
     */
