...
class Vault 
{
            ...
            <div class="flex max-sm:flex-col min-h-screen h-full max-sm:space-y-6 sm:space-x-6 mt-4">
                ...
                <div class="w-full max-w-xl">
                    <div class="mb-4">
                        ...
                        <hr class="">
                        <?php echo (new ShowVaultItem())->render('afdaf') ?>
                    </div>
                <?php
        $form = ob_get_clean();
        $this->addAssets();
    ...
    {
        wp_enqueue_script('fulentplugin_vault', FULENTPLUGIN_URL . 'assets/js/vault.js', array('jquery'), FULENTPLUGIN_VERSION, true);
